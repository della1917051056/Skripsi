...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href=Dashboard>
        <center>
            ...
            <span class="brand-text font-weight-light"><b>Penentuan Grade Biji Kopi Robusta</b></span>
        </center>
    </a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="/Subkriteria"
                                class="nav-link <?php if ($head == "Data Subkriteria") echo "active"; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Subkriteria</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/Alternatif"
                                class="nav-link <?php if ($head == "Data Alternatif") echo "active"; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Alternatif</p>
                            </a>
                        </li>
